...
final class SkiDataCustomer {
     ...
     * Get the deposit.
     *
     * @return integer Returns the deposit.
     */
     ...
     *
     * @return boolean Returns the group couting.
     */
     ...
     *
     * @return integer Returns the maximum level.
     */
     ...
     * @return SkiDataCustomerEntity Returns the SkiData customer entity.
     */
